...
public class PanelScreens extends Panel {
    ...
    public PanelScreens(Window window) {
        ...
        if (Platform.MACOS == Platform.CURRENT) {
            titleStyles = new Options("Default", "Hidden", "Transparent",
                    "Unified", "Unified Compact", "Unified Transparent",
                    "Unified Compact Transparent");
    ...
    public void accept(Event e) {
        ...
        if (e instanceof EventKey eventKey) {
            if (eventKey.isPressed() && eventKey.isModifierDown(Example.MODIFIER)) {
