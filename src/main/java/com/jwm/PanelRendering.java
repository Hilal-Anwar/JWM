...
public class PanelRendering extends Panel {
    ...
    public void paintImpl(Canvas canvas, int width, int height, float scale) {
        try (var paint = new Paint()) {
            ...
            canvas.drawRRect(RRect.makeXYWH(0, 0, width - Example.PADDING * 2,
                    32 * scale, 4 * scale, 4 * scale, 0, 0), paint);
            ...
            try (var line = TextLine.make("VSYNC", Example.FONT24); ) {
                ...
                canvas.drawTextLine(line, width - line.getWidth() - 2 * Example.PADDING,
                        capHeight + 2 * Example.PADDING, paint);
